...
//     // Dummy data for demonstration. Replace with actual API call if available.
//     const dummyCourses = [
//       { id: 1, title: "React for Beginners", description: "Learn the basics of React." },
//       { id: 2, title: "Advanced JavaScript", description: "Master JavaScript with advanced concepts and techniques." }
//     ];
...
//     await getCrimePodcasts();
//     await getSportsPodcasts();
//     await getCourses(); // Fetch the courses
//     setLoading(false);
//   }
...
//                 <div key={course.id} style={{border: '1px solid #ccc', padding: '10px', borderRadius: '5px', width: '200px'}}>
//                   <h3>{course.title}</h3>
